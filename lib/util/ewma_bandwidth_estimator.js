 ...
 * @export
 */
shaka.util.EWMABandwidthEstimator = function(onSampleCallback) {
  ...
  /**
   * This is not original Shaka, added by Jan Fornoff get samples for bandwidth estimator
   */
  this.onSampleCallback_ = onSampleCallback
};
...
shaka.util.EWMABandwidthEstimator.prototype.sample = function(delayMs, bytes) {
  this.onSampleCallback_(delayMs, bytes);
